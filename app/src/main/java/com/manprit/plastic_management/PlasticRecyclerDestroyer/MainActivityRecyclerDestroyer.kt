...
import com.manprit.plastic_management.Fragments.DetailedHistoryFragmentRecycler
...
class MainActivityRecyclerDestroyer : AppCompatActivity() {
...
//        btnUpdateProfile = findViewById(R.id.btnUpdateProfile)
        ...
        floatingActionBtn.setOnClickListener {
            supportFragmentManager.beginTransaction().replace(
                ...
                DetailedHistoryFragmentRecycler()
            ).commit()
        }
...
//        }
    ...
    override fun onBackPressed() {
        ...
        when(frag){
            is homefrag2 -> {
                val dialog = AlertDialog.Builder(this@MainActivityRecyclerDestroyer)
                    .setTitle("Exit")
