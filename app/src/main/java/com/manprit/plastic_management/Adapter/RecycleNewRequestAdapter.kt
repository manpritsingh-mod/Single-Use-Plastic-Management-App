...
class RecycleNewRequestAdapter (val context: Context, val itemList: ArrayList<RequestDetailsData>): RecyclerView.Adapter<RecycleNewRequestAdapter.HomeViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeViewHolder {
            val view =
                LayoutInflater.from(parent.context).inflate(R.layout.recycler_new_request_items, parent, false)
