...
class RecycleHistoryAdapterRecyclerToDestroyer (val context: Context, val itemList: ArrayList<RequestDetailsData>): RecyclerView.Adapter<RecycleHistoryAdapterRecyclerToDestroyer.HomeViewHolder>() {
