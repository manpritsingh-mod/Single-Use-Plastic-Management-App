...
class RecycleHistoryAdapterCorridorToRecycler (val context: Context, val itemList: ArrayList<RequestDetailsData>): RecyclerView.Adapter<RecycleHistoryAdapterCorridorToRecycler.HomeViewHolder>() {
