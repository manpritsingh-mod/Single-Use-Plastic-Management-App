...
class RecycleDetailedHistoryIndividualAdapter (val context: Context, val itemList: ArrayList<RequestDetailsData>): RecyclerView.Adapter<RecycleDetailedHistoryIndividualAdapter.HomeViewHolder>() {
