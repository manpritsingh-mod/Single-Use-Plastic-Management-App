...
class IndividualHistoryAdapter (val context: Context, val itemList: ArrayList<IndividualRequestFormData>): RecyclerView.Adapter<IndividualHistoryAdapter.HomeViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.recycler_new_request_items_individual,parent,false)
    ...
    override fun onBindViewHolder(holder: HomeViewHolder, position: Int) {
        ...
        holder.txtStatus.text = "Status : ${detailsData.Status} By Bank ${detailsData.acceptedByUid}"
