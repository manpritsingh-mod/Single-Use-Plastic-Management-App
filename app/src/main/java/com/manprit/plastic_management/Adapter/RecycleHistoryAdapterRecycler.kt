...
class RecycleHistoryAdapterRecycler (val context: Context, val itemList: ArrayList<RequestDetailsData>): RecyclerView.Adapter<RecycleHistoryAdapterRecycler.HomeViewHolder>() {
...
//            holder.txtWeight.text = "Weight : ${detailsData.Weight} Kg"
        ...
        if(detailsData.sourceType.toString().equals("Corridor"))
        ...
        if(detailsData.sourceType.toString().equals("Corridor"))
            ...
            holder.txtStatus.text = "Status : ${detailsData.Status} by Destroyer ${detailsData.acceptedByUid}"
