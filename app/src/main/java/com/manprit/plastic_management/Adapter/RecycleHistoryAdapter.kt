...
class RecycleHistoryAdapter (val context: Context, val itemList: ArrayList<RequestDetailsData>): RecyclerView.Adapter<RecycleHistoryAdapter.HomeViewHolder>() {
    ...
    override fun onBindViewHolder(holder: HomeViewHolder, position: Int) {
        ...
        if(detailsData.sourceType.toString().equals("Individual"))
            holder.txtStatus.text = "Status : ${detailsData.Status} by Me"
        else
            holder.txtStatus.text = "Status : ${detailsData.Status} by Corridor ${detailsData.acceptedByUid}"
