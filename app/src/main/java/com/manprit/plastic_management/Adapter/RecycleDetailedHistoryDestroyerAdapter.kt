...
class RecycleDetailedHistoryDestroyerAdapter (val context: Context, val itemList: ArrayList<RequestDetailsData>): RecyclerView.Adapter<RecycleDetailedHistoryDestroyerAdapter.HomeViewHolder>() {
    ...
    override fun onBindViewHolder(holder: HomeViewHolder, position: Int) {
        ...
        if(detailsData.sourceType.toString().equals("Recycler"))
