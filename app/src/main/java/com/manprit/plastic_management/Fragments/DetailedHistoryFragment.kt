...
class DetailedHistoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerLayout.adapter = RecycleDetailedHistoryAdapter(activity as Context, statusDetailDataArray)
...
//                           RecycleHistoryAdapter(activity as Context, statusDetailDataArray)
                       ...
                       recyclerLayout?.adapter = activity?.let { RecycleDetailedHistoryAdapter(it, statusDetailDataArray) }
