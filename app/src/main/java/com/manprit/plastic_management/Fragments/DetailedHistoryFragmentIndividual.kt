...
class DetailedHistoryFragmentIndividual : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerLayout.adapter = RecycleDetailedHistoryIndividualAdapter(activity as Context, statusDetailDataArray)
...
//                           RecycleHistoryAdapter(activity as Context, statusDetailDataArray)
                       ...
                       recyclerLayout?.adapter = activity?.let { RecycleDetailedHistoryIndividualAdapter(it, statusDetailDataArray) }
