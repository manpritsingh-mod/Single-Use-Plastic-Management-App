...
class HistoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerLayout.adapter = RecycleHistoryAdapter(activity as Context, statusDetailDataArray)
...
//                           RecycleHistoryAdapter(activity as Context, statusDetailDataArray)
                       ...
                       recyclerLayout?.adapter = activity?.let { RecycleHistoryAdapter(it, statusDetailDataArray) }
