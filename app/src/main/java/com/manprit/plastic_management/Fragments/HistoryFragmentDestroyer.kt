...
import com.manprit.plastic_management.Adapter.RecycleHistoryAdapterDestroyer
...
class HistoryFragmentDestroyer : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerLayout.adapter = RecycleHistoryAdapterDestroyer(activity as Context, statusDetailDataArray)
...
//                            RecycleHistoryAdapter(activity as Context, statusDetailDataArray)
                        ...
                        recyclerLayout?.adapter = activity?.let { RecycleHistoryAdapterDestroyer(it, statusDetailDataArray) }
