...
import com.manprit.plastic_management.Adapter.RecycleHistoryAdapterRecyclerToDestroyer
...
class MyReqFragmentRecyclerToDestroyer : Fragment(){
    ...
    override fun onCreateView(
        ...
        recyclerLayout.adapter = RecycleHistoryAdapterRecyclerToDestroyer(activity as Context, statusDetailDataArray)
...
//                            RecycleHistoryAdapter(activity as Context, statusDetailDataArray)
                        ...
                        recyclerLayout?.adapter = activity?.let { RecycleHistoryAdapterRecyclerToDestroyer(it, statusDetailDataArray) }
