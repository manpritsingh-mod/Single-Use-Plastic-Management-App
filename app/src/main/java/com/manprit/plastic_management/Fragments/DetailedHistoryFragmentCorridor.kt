...
class DetailedHistoryFragmentCorridor : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerLayout.adapter = RecycleDetailedHistoryCorridorAdapter(activity as Context, statusDetailDataArray)
...
//                           RecycleHistoryAdapter(activity as Context, statusDetailDataArray)
                       ...
                       recyclerLayout?.adapter = activity?.let { RecycleDetailedHistoryCorridorAdapter(it, statusDetailDataArray) }
