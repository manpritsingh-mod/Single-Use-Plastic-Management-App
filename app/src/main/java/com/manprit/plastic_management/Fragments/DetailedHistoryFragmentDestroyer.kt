...
import com.manprit.plastic_management.Adapter.RecycleDetailedHistoryDestroyerAdapter
...
class DetailedHistoryFragmentDestroyer : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerLayout.adapter = RecycleDetailedHistoryDestroyerAdapter(activity as Context, statusDetailDataArray)
...
//                           RecycleHistoryAdapter(activity as Context, statusDetailDataArray)
                       ...
                       recyclerLayout?.adapter = activity?.let { RecycleDetailedHistoryDestroyerAdapter(it, statusDetailDataArray) }
           ...
           database2 = FirebaseDatabase.getInstance().getReference("RequestFormDeposit")
...
//                           RecycleHistoryAdapter(activity as Context, statusDetailDataArray)
           ...
           database3 = FirebaseDatabase.getInstance().getReference("RequestFormCollection")
           database4 = FirebaseDatabase.getInstance().getReference("RequestToRecycler")
