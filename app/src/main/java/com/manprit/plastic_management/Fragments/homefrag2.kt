...
import com.manprit.plastic_management.PlasticRecyclerDestroyer.CurrentReqDetailRecycler
...
class homefrag2() : Fragment() {
    ...
    private lateinit var collectbar : ConstraintLayout
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_homefrag2, container, false)
        ...
        formCard = view.findViewById(R.id.PlasticBankcard)
        txtusername = view.findViewById(R.id.txtusername)
//        txtView = view.findViewById(R.id.txtView1)
        ScreenType = view.findViewById(R.id.ScreenType)
        ScreenType.text = "Plastic Recycler"



        formCard.setOnClickListener {
            startActivity(Intent(context as Context, form_Recycler_Destroyer::class.java))
        }
        ...
        StatusBtn.setOnClickListener {
            ...
            startActivity(Intent(context as Context, CurrentReqDetailRecycler::class.java))
