...
import com.manprit.plastic_management.Form.form_Corridor
...
import com.manprit.plastic_management.PlasticCorridor.HistoryPC
import com.manprit.plastic_management.PlasticCorridor.ReqPc
...
class homefragCorridor() : Fragment() {
...
//    lateinit var btnRequest : ImageView
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_home_corridor, container, false)
...
//        btnRequest = view.findViewById(R.id.btnReq)
        ...
        ScreenType.text = "Plastic Corridor"

        btnDeposit.text = "Collection Req to Recycler"
        ...
        requestBtn.setOnClickListener {
            ...
            startActivity(Intent(requireContext(), ReqPc::class.java))
        }
        statusBtn.setOnClickListener {

            startActivity(Intent(requireContext(), CurrentReqDetail::class.java))
        }
        historyBtn.setOnClickListener {

            startActivity(Intent(requireContext(), HistoryPC::class.java))
        }
...
//        }
        ...
        btnDeposit.setOnClickListener {
            val intent = Intent(context as Context , form_Corridor::class.java)
            intent.putExtra("Remove",true)
            intent.putExtra("Title","Plastic Collection Form")
            startActivity(intent)
        }
