...
class StatusFragmentCorridor() : Fragment(), OnButtonClickListener,OnButtonClicked {
    ...
    override fun onCreateView(
        ...
        recyclerLayout.adapter = RecycleStatusCorridorAdapter(activity as Context, statusDetailDataArray,buttonclick,clickListiner,uid!!)
                    ...
                    if (snapshot.exists()) {
                        ...
                        for (dataSnapShot in snapshot.children) {
                            if (dataSnapShot.key != "test") {
                                ...
                                if (detailsData!!.Status.equals("Accepted") && detailsData.acceptedByUid.toString().equals(uid))
                        ...
                        recyclerLayout.layoutManager = LinearLayoutManager(activity)
//                        recyclerLayout.adapter = RecycleStatusCorridorAdapter(
//                            activity as Context,
...
//                        )
                        ...
                        recyclerLayout?.adapter = activity?.let { RecycleStatusCorridorAdapter(it, statusDetailDataArray,buttonclick, clickListiner,uid) }
